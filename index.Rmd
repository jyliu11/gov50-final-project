...
The following plot provides a visual representation of the demographic composition within "Best Zones" (HOLC Grade A) and "Hazardous Zones" (HOLC Grade D). Each bar represents the percentage of a specific racial or ethnic group, allowing for a quick comparison of population distribution between historically privileged and disadvantaged zones. This visualization serves as a preliminary exploration of the main outcome of interest, offering an initial insight into how HOLC redlining practices may have influenced the contemporary demographic makeup of these areas. Further statistical analyses will delve into the nuances of these patterns and their implications for enduring racial and ethnic disparities within metropolitan regions.
